          ...
          <div className='card purple darken-2 project-summary'>
            <div className='card-content white-text'>
              ...
              <p>
                ...
                use effectively. I am a very simple card. I am good at
                containing small bits of information. I am convenient because I
                require little markup to use effectively. I am a very simple
                card. I am good at containing small bits of information. I am
                convenient because I require little markup to use effectively. I
            ...
            <div className='card-action'>
              <span className='grey-text'>Posted by Mehedi</span>
              <span className='grey-text right'>3rd September, 2pm</span>
            </div>
          </div>
        </div>
      </div>
